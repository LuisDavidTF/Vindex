...
CREATE TABLE `__new_boxes` (
	...
	`name` text NOT NULL,
	`created_at` text DEFAULT '2026-06-02T16:42:41.763Z' NOT NULL,
	`updated_at` text DEFAULT '2026-06-02T16:42:41.766Z' NOT NULL
);
